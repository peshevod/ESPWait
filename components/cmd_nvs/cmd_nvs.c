...
const _par_t _pars[]={
	...
	{PAR_STR,"Dev1Name",{.str="���"}, "Dev1 Name",VISIBLE  },
	{PAR_STR,"Dev1s1",{.str="����"}, "Dev1 Sensor1 Name",VISIBLE  },
	{PAR_STR,"Dev1s2",{.str="�����"}, "Dev1 Sensor2 Name",VISIBLE  },
	...
	{PAR_STR,"Dev2Name",{.str="�����"}, "Dev2 Name",VISIBLE  },
	{PAR_STR,"Dev2s1",{.str="������"}, "Dev2 Sensor1 Name",VISIBLE  },
	{PAR_STR,"Dev2s2",{.str="�����"}, "Dev2 Sensor2 Name",VISIBLE  },
	...
	{PAR_STR,"Dev3s1",{.str="Sensor1"}, "Dev3 Sensor1 Name",VISIBLE  },
	{PAR_STR,"Dev3s2",{.str="Sensor2"}, "Dev3 Sensor2 Name",VISIBLE  },
